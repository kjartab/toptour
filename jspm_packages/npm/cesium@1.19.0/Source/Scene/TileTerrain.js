...
(function(Buffer, process) {
  define(['../Core/BoundingSphere', '../Core/Cartesian3', '../Core/ComponentDatatype', '../Core/defined', '../Core/DeveloperError', '../Core/IndexDatatype', '../Core/OrientedBoundingBox', '../Core/TileProviderError', '../Renderer/Buffer', '../Renderer/BufferUsage', '../Renderer/VertexArray', '../ThirdParty/when', './TerrainState', './TileBoundingBox'], function(BoundingSphere, Cartesian3, ComponentDatatype, defined, DeveloperError, IndexDatatype, OrientedBoundingBox, TileProviderError, Buffer, BufferUsage, VertexArray, when, TerrainState, TileBoundingBox) {
    'use strict';
