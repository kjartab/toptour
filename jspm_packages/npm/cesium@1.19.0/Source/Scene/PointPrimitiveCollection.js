...
(function(Buffer) {
  define(['../Core/BoundingSphere', '../Core/Cartesian2', '../Core/Cartesian3', '../Core/Color', '../Core/ComponentDatatype', '../Core/defaultValue', '../Core/defined', '../Core/defineProperties', '../Core/destroyObject', '../Core/DeveloperError', '../Core/EncodedCartesian3', '../Core/Math', '../Core/Matrix4', '../Core/PrimitiveType', '../Renderer/BufferUsage', '../Renderer/ContextLimits', '../Renderer/DrawCommand', '../Renderer/RenderState', '../Renderer/ShaderProgram', '../Renderer/ShaderSource', '../Renderer/VertexArrayFacade', '../Shaders/PointPrimitiveCollectionFS', '../Shaders/PointPrimitiveCollectionVS', './BlendingState', './Pass', './PointPrimitive', './SceneMode'], function(BoundingSphere, Cartesian2, Cartesian3, Color, ComponentDatatype, defaultValue, defined, defineProperties, destroyObject, DeveloperError, EncodedCartesian3, CesiumMath, Matrix4, PrimitiveType, BufferUsage, ContextLimits, DrawCommand, RenderState, ShaderProgram, ShaderSource, VertexArrayFacade, PointPrimitiveCollectionFS, PointPrimitiveCollectionVS, BlendingState, Pass, PointPrimitive, SceneMode) {
    ...
    function PointPrimitiveCollection(options) {
      ...
      this._buffersUsage = [BufferUsage.STATIC_DRAW, BufferUsage.STATIC_DRAW, BufferUsage.STATIC_DRAW, BufferUsage.STATIC_DRAW, BufferUsage.STATIC_DRAW, BufferUsage.STATIC_DRAW, BufferUsage.STATIC_DRAW, BufferUsage.STATIC_DRAW];
      var that = this;
      this._uniforms = {u_maxTotalPointSize: function() {
          return that._maxTotalPointSize;
        }};
    }
    defineProperties(PointPrimitiveCollection.prototype, {length: {get: function() {
    ...
    PointPrimitiveCollection.prototype.update = function(frameState) {
      ...
      if (pass.render) {
        ...
        if (!defined(this._sp) || (this._shaderScaleByDistance && !this._compiledShaderScaleByDistance) || (this._shaderTranslucencyByDistance && !this._compiledShaderTranslucencyByDistance)) {
          vs = new ShaderSource({sources: [PointPrimitiveCollectionVS]});
      ...
      if (picking) {
        ...
        if (!defined(this._spPick) || (this._shaderScaleByDistance && !this._compiledShaderScaleByDistancePick) || (this._shaderTranslucencyByDistance && !this._compiledShaderTranslucencyByDistancePick)) {
          vs = new ShaderSource({
