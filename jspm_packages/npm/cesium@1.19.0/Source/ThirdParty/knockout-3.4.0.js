      ...
      (function(n) {
        ...
        a.a = function() {
          ...
          return {
            ...
            jc: function(b) {
              b = a.a.V(b);
              for (var c = (b[0] && b[0].ownerDocument || u).createElement("div"),
                  d = 0,
                  e = b.length; d < e; d++)
                c.appendChild(a.$(b[d]));
              return c;
        ...
        a.la.fn = {
          remove: function(b) {
            for (var c = this.t(),
                d = [],
                e = "function" != typeof b || a.H(b) ? function(a) {
                  return a === b;
                } : b,
                f = 0; f < c.length; f++) {
              var g = c[f];
              ...
              if (e && !k) {
                ...
                switch (c) {
                  ...
                  case "splice":
                    ...
                    for (var g = 1 === t ? g : Math.min(c + (d[1] || 0), g),
                        t = c + t - 2,
                        G = Math.max(g, t),
                        P = [],
                        n = [],
 ...
 while (h = h.nextSibling);
        ...
        a.a.ib = function() {
          function b(b, d, e, f, g) {
            ...
            h = n;
            for (q = p; h || q; )
              p = m[h][q] - 1, q && p === m[h][q - 1] ? l.push(k[k.length] = {
                status: e,
                value: d[--q],
                index: q
