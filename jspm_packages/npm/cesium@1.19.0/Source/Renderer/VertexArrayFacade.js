...
"format cjs";
(function(Buffer) {
  define(['../Core/ComponentDatatype', '../Core/defaultValue', '../Core/defined', '../Core/destroyObject', '../Core/DeveloperError', '../Core/Math', './Buffer', './BufferUsage', './VertexArray'], function(ComponentDatatype, defaultValue, defined, destroyObject, DeveloperError, CesiumMath, Buffer, BufferUsage, VertexArray) {
    'use strict';
    ...
    var createWriters = [function(buffer, view, vertexSizeInComponentType) {
